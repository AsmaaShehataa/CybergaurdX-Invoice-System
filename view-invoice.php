...
$bill_name = $_SESSION['last_bill_info']['name'] ?? $invoice['client_name'];
$bill_email = $_SESSION['last_bill_info']['email'] ?? $invoice['client_email'];
$bill_phone = $_SESSION['last_bill_info']['phone'] ?? $invoice['client_phone'];
?>
      ...
      <div class="stamp-section">
        <div class="stamp-logo-container">
          <?php if (file_exists('logo.png')): ?>
            <img src="logo.png" alt="CyberGuardX Logo" class="stamp-logo">
          <?php else: ?>
            <div style="font-size: 14px; font-weight: bold; color: #2c3e50;">CYBERGUARDX</div>
          <?php endif; ?>
        </div>
